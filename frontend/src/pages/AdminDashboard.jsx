                ...
                <form onSubmit={handleCreateProduct} className="space-y-6">
                    ...
                    <div className="flex gap-4">
                      {['S', 'M', 'L', 'XL'].map((size) => (
                        ...
                        >
                          ...
                          />
                          <span className="text-gray-700 dark:text-gray-300 font-medium group-hover:text-primary-pink transition-colors">
                            {size}
                          </span>
                        </label>
                      ))}
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                      Product Image{' '}
                      {editingProduct
                        ? '(Optional - leave blank to keep current image)'
                        : '(Required)'}
                    </label>
                    <div className="flex items-center justify-center w-full">
                      <label className="flex flex-col items-center justify-center w-full h-48 border-2 border-dashed rounded-xl cursor-pointer border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                        <div className="flex flex-col items-center justify-center pt-5 pb-6">
                          ...
                          {imageFile && (
                            <p className="mt-4 px-4 py-1.5 bg-pink-100 text-pink-700 dark:bg-pink-900/30 dark:text-pink-300 rounded-full font-medium truncate max-w-[200px] text-sm">
                              ✓ {imageFile.name}
                            </p>
                          )}
                        </div>
            ...
            {activeTab === 'users' && (
              ...
              >
                <div className="flex justify-between items-center mb-6">
                  ...
                  <button
                    onClick={fetchUsers}
                    className="text-primary-pink hover:text-pink-600 font-medium text-sm flex items-center gap-1 bg-pink-50 dark:bg-pink-900/20 px-3 py-1.5 rounded-lg transition-colors"
                  >
                    <svg
                      className="w-4 h-4"
                      fill="none"
                    ...
                    <table className="w-full text-left text-sm text-gray-500 dark:text-gray-400">
                      ...
                      <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                        {users.map((u) => (
                          <tr
                            key={u._id}
                            className="bg-white dark:bg-gray-800 hover:bg-pink-50/50 dark:hover:bg-gray-700/50 transition-colors"
                          >
                      ...
                      <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                        {products.map((p) => (
                          ...
                          >
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="flex flex-col">
                                <span className="font-medium text-gray-900 dark:text-white text-base truncate max-w-[200px]">
                                  {p.title}
                                </span>
                              </div>
                            </td>
